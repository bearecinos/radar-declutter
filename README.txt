...
noArcpy.py - As above but faster as it doesn't rely on the arcmap rasters.
	     Instead takes its data from maps.npz and info.txt.
...
edges.pt - started looking into detecting edges in images to consider
